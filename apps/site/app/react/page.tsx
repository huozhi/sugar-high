...
function codeBlockExample(typed: boolean) {
  return `import { Code } from '@sugar-high/react'
import { taffy } from '@sugar-high/react/themes'

export default function CodePreview({ source }${typed ? ': { source: string }' : ''}) {
  return (
    <section>
      <Code
        title="example.js"
      ...
      <div className="product-page react-product">
        <div className="product-shell">
          ...
          <section className="product-section">
            ...
            <div className="react-demo-theme-picker"><ReactThemePicker label="Code theme" /></div>
            <CodeDemo examples={{ typescript: codeBlockExample(true), javascript: codeBlockExample(false) }} />
          </section>
          ...
          <section className="product-section react-api">
            ...
            <div className="react-demo-theme-picker"><ReactThemePicker label="Theme example" /></div>
            <ThemeUsage />
            <ThemeNames />
          </section>
          ...
          <details className="product-section react-api react-api-details">
            ...
            <div className="react-api__component">
              ...
              <p className="react-style-note">
                ...
                variables above remain available as low-level overrides.
              </p>
            </div>
            <a
