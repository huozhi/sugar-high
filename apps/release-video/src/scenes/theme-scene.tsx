...
const THEMES: { name: string; lang: LanguageName; code: string; bg: string; text: string; keyword: string; string: string; property: string; comment: string }[] = [
  { name: 'Sugar High', lang: 'typescript', code: `type Theme = 'light' | 'dark'\n\nconst release = {\n  name: 'sugar-high',\n  version: 2,\n  languages: 25,\n}\n\nconsole.log(\`v\${release.version}\`)`, bg: '#f8f9fa', text: '#354150', keyword: '#f47067', string: '#00a99a', property: '#4e8fdf', comment: '#a19595' },
  { name: 'Gruvbox', lang: 'python', code: `def highlight(source, language):\n    tokens = parse(source)\n    theme = "quiet-light"\n    result = render(tokens, theme)\n    return result\n\ncode = "print('hello')"\nprint(highlight(code, "python"))`, bg: '#282828', text: '#ebdbb2', keyword: '#fb4934', string: '#b8bb26', property: '#83a598', comment: '#928374' },
  ...
  { name: 'Quiet Light', lang: 'css', code: `code[data-theme] {\n  --theme: gruvbox;\n  --accent: #fb4934;\n\n  color: var(--foreground);\n  background: var(--surface);\n  font-family: ui-monospace;\n}`, bg: '#f5f5f5', text: '#333333', keyword: '#7a3e9d', string: '#448c27', property: '#006ab1', comment: '#aaaaaa' },
